...
$token = "7c9f1f8d02a2f71f58fa92c2a6d6adf1de9a48649cb6fbe9601f761c71fd44d4"; // ← PON TU TOKEN AQUÍ
...
if ($httpCode === 200) {
    ...
    if (isset($data['success']) && $data['success']) {
        ...
        echo json_encode(['error' => $data['message'] ?? 'No encontrado']);
    }
} else {
